...
//         cucumber '**/cucumber.json'
	...
	stage('Create Test execution in JIRA') {
        ...
        step([$class: 'XrayImportBuilder', endpointName: '/junit', importFilePath: 'junit.xml', importInParallel: 'false', importToSameExecution: 'false', projectKey: 'DEMO', serverInstance: 'SERVER-e8a41998-c809-4234-8fa1-1951c4a589c6', testExecKey: 'DEMO-6'])
